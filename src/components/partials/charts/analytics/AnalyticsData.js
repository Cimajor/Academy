  ...
  datasets: [
    {
     ...
     pointBorderColor: "transparent",
      ...
      pointHitRadius: 4,
      data: [
        24000, 24300, 24300, 5180, 4400, 5170, 6460, 8830, 5290, 5430, 4690, 4350, 4600, 5200, 5650, 6850, 6950, 4150,
    ...
    },
    {
     ...
     pointBorderColor: "transparent",
      ...
      pointHitRadius: 4,
      data: [
        24000, 4220, 4810, 5480, 4600, 5670, 6660, 4830, 5590, 5730, 4790, 4950, 5100, 5800, 5950, 5850, 5950, 4450,
  ...
  datasets: [
    {
     ...
     pointBorderColor: "transparent",
      ...
      pointRadius: 4,
      pointHitRadius: 4,
      data: [24000, 4420, 4110, 5180, 4400, 5170, 6460],
    },
    {
      label: "Prev Month",
      color: "#798bff",
  ...
  datasets: [
    {
     ...
     pointBorderColor: "transparent",
      ...
      pointHitRadius: 4,
      data: [
        24000, 24300, 25000, 26000, 27000, 28000, 28000, 29000,  30000,  31000,  34000,  37000, 39000,  43000, 48000, 51000,  54000,  57000, 61000,  66000,  68000,
        74000,  83000, 85000, 90000, 96000, 98000, 100000, 103000, 110000,
      ],
    },
  ],
};
