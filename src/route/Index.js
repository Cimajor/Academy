...
const Pages = () => {
  ...
  return (
    ...
    <Routes>
      ...
      <Route exact path={`${process.env.PUBLIC_URL}/applied-profession/frontend`} component={MainFrontend}></Route>
