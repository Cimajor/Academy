...
export const ProjectListPage = () => {
  ...
  const listAllProfessionSkills = () => {
    _getProfessionById(id)
      .then((res) => {
        ...
        if (array.length > 0) {
          getAllProfessionSkillsData(res.data().skills);
  ...
  const getAllProfessionSkillsData = (arrayOfSkillsId) => {
    ...
    <React.Fragment>
      ...
      <Content>
        <BlockHead size="sm">
          <BlockBetween>
            <BlockHeadContent>
              <BlockTitle page> List of Skills</BlockTitle>
