...
const GeneralProfessionInfo = ({ professionData }) => {
  //   const { contextData } = useContext(UserContext)
  const [noteData, setNoteData] = useState([1, 2, 3]);
  const [currentProfessionData, setCurrentProfessionData] = useState(professionData);
  return (
    <React.Fragment>
      {currentProfessionData ? (
        <>
          {console.log(currentProfessionData)}
          <div className="card-inner">
            <Block>
              <BlockHead>
                <BlockTitle tag="h5">Profession Information</BlockTitle>
              ...
              <div className="profile-ud-list">
                <div className="profile-ud-item">
                  <div className="profile-ud wider">
                    ...
                    <span className="profile-ud-value">{currentProfessionData.name}</span>
                  </div>
                </div>
                <div className="profile-ud-item">
                  <div className="profile-ud wider">
                    <span className="profile-ud-label">Complexity</span>
                    <span className="profile-ud-value">{currentProfessionData.complexity}</span>
                  </div>
                </div>
                <div className="profile-ud-item">
                  <div className="profile-ud wider">
                    <span className="profile-ud-label">Hours to learn</span>
                    <span className="profile-ud-value">{currentProfessionData.hours}</span>
                  </div>
                </div>
              </div>
              <div className="profile-ud-long">
                <div className="profile-ud-item">
                  <div className="profile-ud wider">
                    ...
                    <span className="profile-ud-value">{currentProfessionData.description}</span>
                  </div>
                </div>
              </div>
            </Block>
...
export default GeneralProfessionInfo;
